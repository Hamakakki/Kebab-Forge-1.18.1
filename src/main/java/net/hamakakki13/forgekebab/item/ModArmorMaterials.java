...
public enum ModArmorMaterials implements ArmorMaterial {
    LEATHER("muta", 2, new int[]{1, 1, 2, 1}, 12, SoundEvents.FUNGUS_BREAK, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.DIRT);
    }),
    CHAIN("chainmail", 15, new int[]{1, 4, 5, 2}, 12, SoundEvents.ARMOR_EQUIP_CHAIN, 0.0F, 0.0F, () -> {
        return Ingredient.of(Items.IRON_INGOT);
    }),
    KEBABNITE("kebabnite", 30, new int[]{2, 5, 8, 2}, 12, SoundEvents.FUNGUS_BREAK, 2.5F, 0.0F, () -> {
        return Ingredient.of(ModItems.KEBAB_SUIKALEET.get());
    });
    ...
    public String getName() {
        return ForgeKebab.MOD_ID + ":" + this.name;
    }
