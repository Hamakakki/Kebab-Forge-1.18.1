...
import net.hamakakki13.forgekebab.screen.slot.ModFuelSlot;
import net.hamakakki13.forgekebab.screen.slot.ModResultSlot;
...
public class Kebab_PaistinMenu extends AbstractContainerMenu {
    private final Kebab_PaistinBlockEntity blockEntity;
    ...
    public boolean stillValid(Player pPlayer) {
        return stillValid(ContainerLevelAccess.create(level, blockEntity.getBlockPos()),
                pPlayer, ModBlocks.KEBAB_PAISTIN.get());
    }
